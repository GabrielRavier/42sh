...
SOURCE_FILES += shell/builtin/commands/cd shell/builtin/commands/env shell/builtin/commands/exit shell/builtin/commands/printenv shell/builtin/commands/setenv shell/builtin/commands/unsetenv shell/builtin/commands/jobs shell/builtin/commands/wait
...
SOURCE_FILES += shell/parse_tree/free shell/parse_tree/from_lex_tree shell/parse_tree/from_lex_tree_part2 shell/parse_tree/from_lex_tree_part3 shell/parse_tree/from_lex_tree_part4 shell/parse_tree/from_lex_tree_part5 shell/parse_tree/from_lex_tree_part6 shell/parse_tree/from_lex_tree_part7
SOURCE_FILES += shell/proc/add shell/proc/wait_current shell/proc/print shell/proc/wait shell/proc/free shell/proc/flush shell/proc/clear_current_previous shell/proc/get_new_current_job shell/proc/flush_all shell/proc/any_stopped shell/proc/end_job
...
SOURCE_FILES += shell/signal/handle_pending shell/signal/enable_sigint shell/signal/int_handler shell/signal/set_interrupting_handler shell/signal/g_shell_signal shell/signal/process_int shell/signal/process_chld shell/signal/chld_handler shell/signal/decr_disable
SOURCE_FILES += shell/tty/grab_pgrp shell/tty/ungrab
SOURCE_FILES += shell/fork/fork
...
obj/%.o: src/%.c libmy
	...
	@mkdir --parents obj/shell/signal
	@mkdir --parents obj/shell/tty
	@mkdir --parents obj/shell/fork
