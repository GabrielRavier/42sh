...
SOURCE_FILES += shell/proc/add shell/proc/wait_current shell/proc/print shell/proc/wait shell/proc/free shell/proc/flush shell/proc/clear_current_previous shell/proc/get_new_current_job shell/proc/flush_all shell/proc/any_stopped
